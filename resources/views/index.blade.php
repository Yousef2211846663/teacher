...
<html class="h-full" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo5/index.html" rel="canonical"/>
 ...
 <body class="antialiased flex h-full text-base text-foreground bg-background [--header-height:54px] [--sidebar-width:200px]">
  ...
  <div class="flex grow flex-col in-data-kt-[sticky-header=on]:pt-(--header-height)">
   <!-- Header -->
   <header class="flex items-center transition-[height] shrink-0 bg-background h-(--header-height)" data-kt-sticky="true" data-kt-sticky-class="transition-[height] fixed z-10 top-0 left-0 right-0 shadow-xs backdrop-blur-md bg-white/70 dark:bg-background/70 border-b border-border" data-kt-sticky-name="header" data-kt-sticky-offset="100px" id="header">
    <!-- Container -->
    <div class="kt-container-fluid flex flex-wrap justify-between items-center lg:gap-4" id="header_container">
        ...
        <div class="kt-menu-item" data-kt-menu-item-offset="0,10px" data-kt-menu-item-placement="bottom-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="hover">
         ...
         <div class="kt-menu-dropdown w-48 py-2">
          <div class="kt-menu-item">
           <a class="kt-menu-link" href="html/demo5/public-profile/profiles/default.html" tabindex="0">
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link" href="html/demo5.html" tabindex="0">
            <span class="kt-menu-icon">
     ...
     <div class="flex items-center gap-3">
      <a class="kt-btn kt-btn-outline" href="html/demo5/account/members/team-members.html">
       <i class="ki-filled ki-users">
       </i>
       Add
      ...
      <div class="flex items-center gap-1">
           ...
           <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
            ...
            <div class="kt-menu-item" data-kt-menu-item-offset="-15px, 0" data-kt-menu-item-placement="right-start" data-kt-menu-item-toggle="dropdown" data-kt-menu-item-trigger="click|lg:hover">
             ...
             <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]">
              <div class="kt-menu-item">
               <a class="kt-menu-link" href="html/demo5/account/home/settings-sidebar.html">
                <span class="kt-menu-icon">
             ...
             <div class="kt-card shadow-none flex items-center flex-row justify-between gap-1.5 px-2.5 py-2 rounded-lg bg-muted/70">
              <div class="flex flex-col">
               ...
               <a class="hover:text-primary text-muted-foreground font-medium text-xs" href="#">
                <span class="__cf_email__" data-cfemail="b5c7dadbd4d9d19bc7dcd6ddd4c7d1c6f5d2d8d4dcd99bd6dad8">[email&#160;protected]</span>
               </a>
              </div>
       ...
       <div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-10px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start">
        <button class="kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:bg-transparent hover:[&_i]:text-primary kt-dropdown-open:bg-transparent kt-dropdown-open:[&_i]:text-primary" data-kt-dropdown-toggle="true">
        ...
        <div class="kt-dropdown-menu p-0 w-screen max-w-[320px]" data-kt-dropdown-menu="true">
         ...
         <div class="grid p-5 border-t border-t-border">
          <a class="kt-btn kt-btn-outline justify-center" href="html/demo5/account/api-keys.html">
           Go to Apps
          </a>
         </div>
        </div>
      ...
      <div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-placement-rtl="bottom-start" data-kt-dropdown-trigger="click">
       ...
       <div class="kt-dropdown-menu w-[250px]" data-kt-dropdown-menu="true">
        <div class="flex items-center justify-between px-2.5 py-1.5 gap-1.5">
         <div class="flex items-center gap-2">
          ...
          <div class="flex flex-col gap-1.5">
           ...
           <a class="text-xs text-secondary-foreground hover:text-primary font-medium leading-none" href="html/demo5/account/home/get-started.html">
            <span class="__cf_email__" data-cfemail="bad994dcd3c9d2dfc8faddd7dbd3d694d9d5d7">[email&#160;protected]</span>
           </a>
          </div>
         </div>
        ...
        <ul class="kt-dropdown-menu-sub">
         ...
         <li>
          <a class="kt-dropdown-menu-link" href="html/demo5/public-profile/profiles/default.html">
         ...
         <li>
          <a class="kt-dropdown-menu-link" href="html/demo5/account/home/user-profile.html">
           <i class="ki-filled ki-profile-circle">
           </i>
           My Profile
          </a>
         ...
         <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start" data-kt-dropdown-trigger="hover">
          ...
          <div class="kt-dropdown-menu w-[220px]" data-kt-dropdown-menu="true">
           <ul class="kt-dropdown-menu-sub">
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo5/account/home/get-started.html">
            ...
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo5/account/security/overview.html">
            ...
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo5/account/members/teams.html">
            ...
            <li>
             <a class="kt-dropdown-menu-link" href="html/demo5/account/integrations.html">
        ...
        <div class="px-2.5 pt-1.5 mb-2.5 flex flex-col gap-3.5">
         ...
         <a class="kt-btn kt-btn-outline justify-center w-full" href="html/demo5/authentication/classic/sign-in.html">
          Log out
         </a>
        </div>
       </div>
      ...
      <div class="kt-scrollable-x-auto">
       <div class="kt-menu gap-5 lg:gap-7.5" data-kt-menu="true">
        <div class="kt-menu-item py-3.5 border-b border-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono">
         <a class="kt-menu-link gap-2.5" href="html/demo5.html">
        ...
        <div class="kt-menu-item py-3.5 border-b border-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono">
         <a class="kt-menu-link gap-2.5" href="html/demo5/public-profile/profiles/default.html">
          <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-mono kt-menu-item-active:font-medium kt-menu-link-hover:text-mono">
           Public Profiles
          </span>
         </a>
        ...
        <div class="kt-menu-item py-3.5 border-b border-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono">
         <a class="kt-menu-link gap-2.5" href="html/demo5/account/home/get-started.html">
          <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-mono kt-menu-item-active:font-medium kt-menu-link-hover:text-mono">
           Account Settings
          </span>
         </a>
        ...
        <div class="kt-menu-item py-3.5 border-b border-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono">
         <a class="kt-menu-link gap-2.5" href="html/demo5/network/get-started.html">
          <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-mono kt-menu-item-active:font-medium kt-menu-link-hover:text-mono">
           Network
          </span>
         </a>
        ...
        <div class="kt-menu-item py-3.5 border-b border-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono">
         <a class="kt-menu-link gap-2.5" href="html/demo5/authentication/get-started.html">
          <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-mono kt-menu-item-active:font-medium kt-menu-link-hover:text-mono">
           Authentication
          </span>
         </a>
        ...
        <div class="kt-menu-item py-3.5 border-b border-transparent kt-menu-item-active:border-b-mono kt-menu-item-here:border-b-mono">
         <a class="kt-menu-link gap-2.5" href="html/demo5/store-client/home.html">
          <span class="kt-menu-title text-nowrap font-medium text-sm text-secondary-foreground kt-menu-item-active:text-mono kt-menu-item-active:font-medium kt-menu-link-hover:text-mono">
           Store - Client
          </span>
         </a>
   ...
   <div class="container-fixed w-full flex px-0 lg:ps-4">
    ...
    <div class="w-(--sidebar-width) shrink-0 hidden lg:flex items-start [--kt-drawer-enable:true] lg:[--kt-drawer-enable:false]" data-kt-drawer="true" data-kt-drawer-class="kt-drawer kt-drawer-start flex top-0 bottom-0" id="sidebar">
     <div class="w-(--sidebar-width) z-5 lg:top-[80px] top-0 bottom-0 lg:right-auto lg:start-auto shrink-0 py-3 lg:py-0 bg-background" data-kt-sticky="true" data-kt-sticky-class="fixed" data-kt-sticky-name="sidebar" data-kt-sticky-offset="150px">
      <div class="kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-height="auto" data-kt-scrollable-offset="10px" id="sidebar_scrollable">
       <!-- Sidebar Menu -->
       <div class="kt-menu flex flex-col w-full px-2.5 gap-0.5" data-kt-menu="true" data-kt-menu-accordion-expand-all="false" id="sidebar_menu">
        <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
         <div class="kt-menu-link py-1.5 ps-2.5 pe-2.5 rounded-md border border-transparent">
         ...
         <div class="kt-menu-accordion gap-px">
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/home/get-started.html">
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/home/user-profile.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             User Profile
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/home/company-profile.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Company Profile
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/home/settings-sidebar.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/home/settings-enterprise.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Settings - Enterprise
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/home/settings-plain.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Settings - Plain
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/home/settings-modal.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Settings - Modal
            </span>
           </a>
        ...
        <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
         ...
         <div class="kt-menu-accordion gap-px">
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/billing/basic.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Billing - Basic
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/billing/enterprise.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Billing - Enterprise
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/billing/plans.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Plans
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/billing/history.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Billing History
            </span>
           </a>
        ...
        <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
         ...
         <div class="kt-menu-accordion gap-px">
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/security/get-started.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Get Started
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/security/overview.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Security Overview
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/security/allowed-ip-addresses.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/security/privacy-settings.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Privacy Settings
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/security/device-management.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Device Management
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/security/backup-and-recovery.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Backup & Recovery
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/security/current-sessions.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Current Sessions
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/security/security-log.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Security Log
            </span>
           </a>
        ...
        <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
         ...
         <div class="kt-menu-accordion gap-px">
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/members/team-starter.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Teams Starter
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/members/teams.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Teams
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/members/team-info.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Team Info
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/members/members-starter.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Members Starter
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/members/team-members.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Team Members
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/members/import-members.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Import Members
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/members/roles.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Roles
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/members/permissions-toggle.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Permissions - Toggler
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/members/permissions-check.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Permissions - Check
            </span>
           </a>
        ...
        <div class="kt-menu-item">
         <a class="kt-menu-link py-1.5 ps-2.5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/integrations.html">
          <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
           Integrations
          </span>
         </a>
        ...
        <div class="kt-menu-item">
         <a class="kt-menu-link py-1.5 ps-2.5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/notifications.html">
          <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
           Notifications
          </span>
         </a>
        ...
        <div class="kt-menu-item">
         <a class="kt-menu-link py-1.5 ps-2.5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/api-keys.html">
          <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
           API Keys
          </span>
         </a>
        ...
        <div class="kt-menu-item flex-col-reverse" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
         ...
         <div class="kt-menu-accordion gap-px">
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-2.5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/appearance.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Appearance
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-2.5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/invite-a-friend.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Invite a Friend
            </span>
           </a>
          ...
          <div class="kt-menu-item">
           <a class="kt-menu-link py-1.5 ps-2.5 pe-2.5 rounded-md border border-transparent kt-menu-item-active:border-border kt-menu-item-active:bg-background kt-menu-link-hover:bg-background kt-menu-link-hover:border-border" href="html/demo5/account/activity.html">
            <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-primary kt-menu-link-hover:text-primary">
             Activity
            </span>
           </a>
      ...
      <div class="kt-container-fluid flex items-center justify-between flex-wrap gap-5">
       <div class="flex items-center flex-wrap gap-1 lg:gap-5">
        ...
        <div class="flex items-center gap-1 text-sm font-normal">
         <a class="text-secondary-foreground hover:text-primary" href="html/demo5.html">
          Home
         </a>
        </div>
       </div>
       <div class="flex items-center gap-1">
        <a class="kt-btn kt-btn-outline" href="html/demo5/public-profile/profiles/default.html">
         View Profile
        </a>
       </div>
      </div>
             ...
             <div class="flex items-center gap-2.5">
              ...
              <div class="flex flex-col">
               ...
               <span class="text-2sm font-normal text-muted-foreground">
                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="91e5e8fdf4e3bff9f4e3fed1f6fcf0f8fdbff2fefc">[email&#160;protected]</a> connections
               </span>
              </div>
             </div>
             <div class="flex items-center gap-2.5">
            ...
            <div class="kt-menu-link flex justify-between gap-2">
             <div class="flex items-center gap-2.5">
              ...
              <div class="flex flex-col">
               ...
               <span class="text-2sm font-normal text-muted-foreground">
                <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7d180e0915180f5315120a1c0f193d1a101c1411531e1210">[email&#160;protected]</a> connections
               </span>
              </div>
             </div>
             <div class="flex items-center gap-2.5">
          ...
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             ...
             <span class="text-2sm font-normal text-muted-foreground">
              <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7c080510190e5214190e133c1b111d1510521f1311">[email&#160;protected]</a> connections
             </span>
            </div>
           </div>
           <div class="flex items-center gap-2.5">
          ...
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             ...
             <span class="text-2sm font-normal text-muted-foreground">
              <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7c190f0814190e5214130b1d0e183c1b111d1510521f1311">[email&#160;protected]</a> connections
             </span>
            </div>
           </div>
           <div class="flex items-center gap-2.5">
          ...
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             ...
             <span class="text-2sm font-normal text-muted-foreground">
              <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7e141f1d111c501411101b0d3e19131f1712501d1113">[email&#160;protected]</a> connections
             </span>
            </div>
           </div>
           <div class="flex items-center gap-2.5">
          ...
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             ...
             <span class="text-2sm font-normal text-muted-foreground">
              <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="19757c6a75707c3778757c6178777d7c6b597e74787075377a7674">[email&#160;protected]</a> connections
             </span>
            </div>
           </div>
           <div class="flex items-center gap-2.5">
          ...
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             ...
             <span class="text-2sm font-normal text-muted-foreground">
              <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e68589829fc8808f958e8394a6818b878f8ac885898b">[email&#160;protected]</a> connections
             </span>
            </div>
           </div>
           <div class="flex items-center gap-2.5">
        ...
        <div class="flex items-center grow gap-2.5">
         ...
         <div class="flex flex-col">
          ...
          <a class="hover:text-primary text-2sm text-secondary-foreground" href="#">
           <span class="__cf_email__" data-cfemail="16626f7a7364387e73647956717b777f7a3875797b">[email&#160;protected]</span>
          </a>
         </div>
        </div>
       ...
       <div class="flex items-center flex-wrap gap-2">
        <div class="flex items-center grow gap-2.5">
         ...
         <div class="flex flex-col">
          ...
          <a class="hover:text-primary text-2sm text-secondary-foreground" href="#">
           <span class="__cf_email__" data-cfemail="8de8fef9e5e8ffa3e5e2faecffe9cdeae0ece4e1a3eee2e0">[email&#160;protected]</span>
          </a>
         </div>
        </div>
        <select class="kt-select max-w-24">
       ...
       <div class="flex items-center flex-wrap gap-2">
        <div class="flex items-center grow gap-2.5">
         ...
         <div class="flex flex-col">
          ...
          <a class="hover:text-primary text-2sm text-secondary-foreground" href="#">
           <span class="__cf_email__" data-cfemail="c6aca7a5a9a4e8aca9a8a3b586a1aba7afaae8a5a9ab">[email&#160;protected]</span>
          </a>
         </div>
        </div>
        <select class="kt-select max-w-24">
       ...
       <div class="flex items-center flex-wrap gap-2">
        <div class="flex items-center grow gap-2.5">
         ...
         <div class="flex flex-col">
          ...
          <a class="hover:text-primary text-2sm text-secondary-foreground" href="#">
           <span class="__cf_email__" data-cfemail="90e4e9fcf5e2bef8f5e2ffd0f7fdf1f9fcbef3fffd">[email&#160;protected]</span>
          </a>
         </div>
        </div>
        <select class="kt-select max-w-24">
       ...
       <div class="flex items-center flex-wrap gap-2">
        <div class="flex items-center grow gap-2.5">
         ...
         <div class="flex flex-col">
          ...
          <a class="hover:text-primary text-2sm text-secondary-foreground" href="#">
           <span class="__cf_email__" data-cfemail="b0d5c3c4d8d5c29ed8dfc7d1c2d4f0d7ddd1d9dc9ed3dfdd">[email&#160;protected]</span>
          </a>
         </div>
        </div>
        <select class="kt-select max-w-24">
       ...
       <div class="flex items-center flex-wrap gap-2">
        <div class="flex items-center grow gap-2.5">
         ...
         <div class="flex flex-col">
          ...
          <a class="hover:text-primary text-2sm text-secondary-foreground" href="#">
           <span class="__cf_email__" data-cfemail="6c060d0f030e42060302091f2c0b010d0500420f0301">[email&#160;protected]</span>
          </a>
         </div>
        </div>
        <select class="kt-select max-w-24">
  ...
  <!-- End of Page -->
  <!-- Scripts -->
  <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/core.bundle.js">
  </script>
